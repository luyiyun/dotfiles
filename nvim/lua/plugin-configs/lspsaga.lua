...
wk.register({
    ["g"] = {
        ...
        p = {"<cmd>Lspsaga peek_definition<CR>", "Lspsaga finder (peek definition)[lspsaga]"},
    },
    ['['] = {
        name = "Diagnosis navigator (previous)",
        ["d"] = {"<cmd>Lspsaga diagnostic_jump_prev<cr>", "previous diagnosis[lspsaga]"},
        ["e"] = {
            function()
    ...
    [']'] = {
        name = "Diagnosis navigator (next)",
        ["d"] = {"<cmd>Lspsaga diagnostic_jump_next<cr>", "next diagnosis[lspsaga]"},
        ["e"] = {
            function()
    ...
    ['<leader>d'] = {
        ...
        a = {"<cmd>Lspsaga code_action<CR>", "code action quickFix[lspsaga]"},
        s = {"<cmd>LSoutlineToggle<CR>", "show symbols[lspsaga]"},
        r = {"<cmd>Lspsaga rename<CR>", "edit symbol name[lspsaga]"},
    },
})

wk.register({
    ["<c-r>"] = {"<cmd>Lspsaga rename<CR>", "edit symbol name[lsp]"},
}, {mode = "v"})
