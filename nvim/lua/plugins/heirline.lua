...
--       "neovim/nvim-lspconfig",  -- diagnostics icons
--     },
--     config = function()
...
--       }
--       heirline.load_colors(colors) -- 可以直接在配置中使用key来设置
--
--       -- 定义需要的模块
--       local ViMode = {
--         -- get vim current mkde, this information will be required by the provider
...
--         -- 需要依赖于lspconfig，因为这些标记的定义来源于lspconfig的config
--         static = {
...
--         utils.surround({ "", "" }, "bright_bg", { ViMode, Snippets }), Space,
--         FileNameBlock, Space,
--         Git, Space,
--         Diagnostics, Align,
